        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/lelenongchanpinxiaoshou/upload/nongchanpinMuBan.xls"
                        >批量导入农产品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('nongchanpin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="nongchanpinNewMoney"
                                   header-align="center"
                                   label="现价">
                        <template slot-scope="scope">
                            {{scope.row.nongchanpinNewMoney}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="nongchanpinClicknum"
                                      header-align="center"
                                      label="点击次数">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('nongchanpin','查看')" type="success" icon="el-icon-tickets" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
                            ...
                            <el-button v-if="isAuth('nongchanpin','修改')" type="primary" icon="el-icon-tickets" size="mini" @click="shangxia(scope.row.id,scope.row.shangxiaTypes)">{{scope.row.shangxiaTypes == 1?'下架':'上架'}}</el-button>
                            <!--<el-button v-if="isAuth('nongchanpin','修改')" type="primary" icon="el-icon-add-location" size="mini" @click="plusNongchanpinKucunNumber(scope.row.id,scope.row.nongchanpinKucunNumber)">增加农产品库存</el-button>-->
                            <!--<el-button v-if="isAuth('nongchanpin','修改')" type="primary" icon="el-icon-delete-location" size="mini" @click="reduceNongchanpinKucunNumber(scope.row.id,scope.row.nongchanpinKucunNumber)">减少农产品库存</el-button>-->
