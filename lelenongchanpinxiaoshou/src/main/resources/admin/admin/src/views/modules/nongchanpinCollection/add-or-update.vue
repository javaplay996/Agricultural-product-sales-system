    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="nongchanpinCollectionTypes">
                        <el-select v-model="ruleForm.nongchanpinCollectionTypes" :disabled="ro.nongchanpinCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in nongchanpinCollectionTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="类型" prop="nongchanpinCollectionValue">
                        <el-input v-model="ruleForm.nongchanpinCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    nongchanpinId: false,
                    yonghuId: false,
                    nongchanpinCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    nongchanpinId: '',
                    yonghuId: '',
                    nongchanpinCollectionTypes: '',
                    insertTime: '',
                },
                nongchanpinCollectionTypesOptions : [],
                nongchanpinOptions : [],
                yonghuOptions : [],
                rules: {
                   nongchanpinId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=nongchanpin_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.nongchanpinCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `nongchanpinCollection/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`nongchanpinCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.nongchanpinCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
