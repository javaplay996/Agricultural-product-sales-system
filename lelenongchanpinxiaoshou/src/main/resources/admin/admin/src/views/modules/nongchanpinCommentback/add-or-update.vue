<template>
    <div class="addEdit-block">
        <el-form
                ...
                >
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='nongchanpin' && sessionTable != 'shangjia'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="nongchanpinCommentbackText">
                        <el-input type="textarea"  :readonly="ro.nongchanpinCommentbackText" v-model="ruleForm.nongchanpinCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.nongchanpinCommentbackText" label="评价内容" prop="nongchanpinCommentbackText">
                            <span v-html="ruleForm.nongchanpinCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    nongchanpinId: false,
                    yonghuId: false,
                    nongchanpinCommentbackText: false,
                    insertTime: false,
                    replyText: false,
                    updateTime: false,
                },
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.nongchanpinId = true;//农产品
                this.ro.yonghuId = true;//用户
                this.ro.nongchanpinCommentbackText = true;//评价内容
            }else{
            }
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `nongchanpinCommentback/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`nongchanpinCommentback/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.nongchanpinCommentbackCrossAddOrUpdateFlag = false;
                                        this.parent.search();
