...
var centerMenu = [
    ...
    ,{
        name: '农产品收藏',
        url: '../nongchanpinCollection/list.html'
    }
    ,{
        name: '农产品订单',
        url: '../nongchanpinOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/lelenongchanpinxiaoshou/admin/dist/index.html#/login";
